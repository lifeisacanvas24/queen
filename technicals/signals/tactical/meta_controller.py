# ============================================================
# quant/signals/tactical/tactical_meta_controller.py
# ------------------------------------------------------------
...
# ============================================================
def detect_performance_drift(model_path: str, event_log_path: str, drift_threshold: float):
...
def meta_controller_run():
    ...
    table = Table(title="🧠 Meta Controller — Decisions", header_style="bold cyan", expand=True)
